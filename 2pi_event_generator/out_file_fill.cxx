...
void out_file_fill(int i, Float_t sigma, Float_t W, Float_t Q2, TLorentzVector& P4_E, TLorentzVector& P4_1,
                   TLorentzVector& P4_2, TLorentzVector& P4_3, Float_t z_EL, Float_t x_EL, Float_t y_EL) {
#ifdef BOS
  ...
  if (flag_lund == 1) {
    out_lund_stream << "4  1.  1.  0  0  " << i << "  0  " << std::fixed << std::setprecision(6) << W << "  " << Q2
                    << "  " << sigma << "\n";
...
void hist_fill(Float_t E_beam, Float_t W, Float_t W_old, Float_t Q2, Float_t Q2_old, Float_t phi_e, Float_t z_EL,
               Float_t s12, Float_t s23, Float_t th_hadr, Float_t alph_hadr, Float_t ph_hadr, Float_t sigma_t_final,
               Float_t sigma_l_final, Float_t eps_l, Float_t sigma_total, TLorentzVector P4_E_prime,
               TLorentzVector P4_Pfin, TLorentzVector P4_PIP, TLorentzVector P4_PIM, TLorentzVector P4_Eini_new,
  ...
  if ((flag_radmod == 0) && (flag_fermi == 1))
    P4_0_miss_2 = P4_Pini_fermi + P4_Eini - P4_E_prime - P4_PIP - P4_Pfin - P4_PIM;
  if ((!(flag_radmod == 0)) && (flag_fermi == 0))
    P4_0_miss_2 = P4_Pini + P4_Eini_new - P4_E_prime_new - P4_PIP - P4_Pfin - P4_PIM;
  if ((!(flag_radmod == 0)) && (flag_fermi == 1))
    P4_0_miss_2 = P4_Pini_fermi + P4_Eini_new - P4_E_prime_new - P4_PIP - P4_Pfin - P4_PIM;

  P4_pim_miss = P4_Pini + P4_Eini - P4_E_prime - P4_PIP - P4_Pfin;

  if ((flag_radmod == 0) && (flag_fermi == 1)) P4_pim_miss_2 = P4_Pini_fermi + P4_Eini - P4_E_prime - P4_PIP - P4_Pfin;
  if ((!(flag_radmod == 0)) && (flag_fermi == 0))
    P4_pim_miss_2 = P4_Pini + P4_Eini_new - P4_E_prime_new - P4_PIP - P4_Pfin;
  if ((!(flag_radmod == 0)) && (flag_fermi == 1))
    P4_pim_miss_2 = P4_Pini_fermi + P4_Eini_new - P4_E_prime_new - P4_PIP - P4_Pfin;

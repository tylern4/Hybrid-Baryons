...
#include <cstdlib>
 ...
 TH1F *h_0_miss_fermi, *h_pim_miss_fermi, *h_0_miss_fermi_2, *h_pim_miss_fermi_2;
 TH1F *h_0_miss_en_fermi, *h_0_miss_en_fermi_2, *h_fermi_bonn, *h_0_miss_en, *h_0_miss_en_2,*h_eradgam;
...
h_0_miss_fermi = new TH1F("h_0_miss_fermi","h_0_miss_fermi",1000,-0.05,0.05);
h_pim_miss_fermi = new TH1F("h_pim_miss_fermi","h_pim_miss_fermi",200,MPIM*MPIM-0.1,MPIM*MPIM+0.1);
h_0_miss_fermi_2 = new TH1F("h_0_miss_fermi_2","h_0_miss_fermi_2",1000,-0.05,0.05);
h_pim_miss_fermi_2 = new TH1F("h_pim_miss_fermi_2","h_pim_miss_fermi_2",200,MPIM*MPIM-0.1,MPIM*MPIM+0.1);
  
h_0_miss_en_fermi = new TH1F("h_0_miss_en_fermi","h_0_miss_en_fermi",200,-0.05,0.05);
h_0_miss_en_fermi_2 = new TH1F("h_0_miss_en_fermi_2","h_0_miss_en_fermi_2",200,-0.05,0.05);

...
void get_xsect_golovach(Float_t Wgen, Float_t s12gen, Float_t s23gen, Float_t thetagen, Float_t alphagen,
  ...
  // cout <<s12left_wleft_bin <<" "<<s12gen<<" "<<S12_ARR_GOL[s12left_wleft_bin][Wleft_bin]<< " "<<
  ...
  // sigma_wleft_gol
  interpol_golovach(Wright_bin, s12left_wright_bin, s12right_wright_bin, s23left_wright_bin, s23right_wright_bin,
                    thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen, alphagen,
                    sigma_wright_gol);

  interpol_golovach(Wleft_bin, s12left_wleft_bin, s12right_wleft_bin, s23left_wleft_bin, s23right_wleft_bin,
                    thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen, alphagen,
                    sigma_wleft_gol);

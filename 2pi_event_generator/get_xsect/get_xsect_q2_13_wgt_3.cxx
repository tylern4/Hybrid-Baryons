...
void get_xsect_q2_13_wgt_3(Float_t Q2gen, Float_t Wgen, Float_t s12gen, Float_t s23gen, Float_t thetagen,
  ...
  Short_t s12left_wleft_bin =
      getsbin_wgt_3(s12gen, S12_ARR_gt_3[15][Wleft_bin], S12_ARR_gt_3[11][Wleft_bin], S12_ARR_gt_3[0][Wleft_bin]);
  Short_t s12right_wleft_bin = s12left_wleft_bin + 1;

  Short_t s12left_wright_bin =
      getsbin_wgt_3(s12gen, S12_ARR_gt_3[15][Wright_bin], S12_ARR_gt_3[11][Wright_bin], S12_ARR_gt_3[0][Wright_bin]);
  Short_t s12right_wright_bin = s12left_wright_bin + 1;

  Short_t s23left_wleft_bin =
      getsbin_wgt_3(s23gen, S23_ARR_gt_3[15][Wleft_bin], S23_ARR_gt_3[11][Wleft_bin], S23_ARR_gt_3[0][Wleft_bin]);
  Short_t s23right_wleft_bin = s23left_wleft_bin + 1;

  Short_t s23left_wright_bin =
      getsbin_wgt_3(s23gen, S23_ARR_gt_3[15][Wright_bin], S23_ARR_gt_3[11][Wright_bin], S23_ARR_gt_3[0][Wright_bin]);
  ...
  for (Short_t j = 0; j < 6; j++) {
    interpol_q2_13_wgt_3(4, Wright_bin, s12left_wright_bin, s12right_wright_bin, s23left_wright_bin,
    ...
    interpol_q2_13_wgt_3(4, Wleft_bin, s12left_wleft_bin, s12right_wleft_bin, s23left_wleft_bin, s23right_wleft_bin,
                         thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen,
                         alphagen, sigma_wleft[j], j);
  }

  interpol_phot_wgt_3(4, Wright_bin, s12left_wright_bin, s12right_wright_bin, s23left_wright_bin, s23right_wright_bin,
                      thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen, alphagen,
                      sigma_wright_ph);

  interpol_phot_wgt_3(4, Wleft_bin, s12left_wleft_bin, s12right_wleft_bin, s23left_wleft_bin, s23right_wleft_bin,
                      thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen, alphagen,
                      sigma_wleft_ph);
  ...
  if ((Q2gen > 0.0002) && (Q2gen <= 0.65)) {
    ...
    sigma_t_fin_ph = sigma_t_fin_ph * (sigma_wright_ph * fabs(W_ARR_gt_3[Wleft_bin] - Wgen) +
    ...
    sigma_final[0] = sigma_final[0] * (sigma_wright[0] * fabs(W_ARR_gt_3[Wleft_bin] - Wgen) +
  ...
  if ((Q2gen >= 0.95) && (Q2gen <= 1.3)) {
    ...
    sigma_l_final = sigma_l_final * (sigma_wright[1] * fabs(W_ARR_gt_3[Wleft_bin] - Wgen) +
  ...
  for (Short_t i = 2; i < 6; i++) {
    ...
    sigma_final[i] = sigma_final[i] * (sigma_wright[i] * fabs(W_ARR_gt_3[Wleft_bin] - Wgen) +
  ...
  // cout << sigma_wright[1]<< " "<< sigma_wleft[1]<<" "<< Wleft_bin<< " "<< s12left_wleft_bin<< " "<<
  // s23left_wleft_bin<< "\n";
}

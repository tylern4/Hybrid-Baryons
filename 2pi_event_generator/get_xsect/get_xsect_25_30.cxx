...
void get_xsect_25_30(Float_t Q2gen, Float_t Wgen, Float_t s12gen, Float_t s23gen, Float_t thetagen, Float_t alphagen,
  ...
  for (Short_t i = 0; i < 6; i++) {
    interpol_rip3(4, Wright_bin, s12left_wright_bin, s12right_wright_bin, s23left_wright_bin, s23right_wright_bin,
                  thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen, alphagen,
                  sigma_wright[i], i);

    interpol_rip3(4, Wleft_bin, s12left_wleft_bin, s12right_wleft_bin, s23left_wleft_bin, s23right_wleft_bin,
                  thetaleft_bin, thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen, thetagen, alphagen,
                  sigma_wleft[i], i);
  }
  ...
  if ((Q2gen > 0.0002) && (Q2gen <= 0.65)) {
    ...
    sigma_t_gol = sigma_t_gol * (sigma_t_wright_gol * fabs(W_ARR_RIP3[Wleft_bin] - Wgen) +
    ...
    sigma_final[0] = sigma_final[0] * (sigma_wright[0] * fabs(W_ARR_RIP3[Wleft_bin] - Wgen) +
  ...
  if ((Q2gen >= 0.95) && (Q2gen <= 1.3)) {
    ...
    sigma_l_final = sigma_l_final * (sigma_wright[1] * fabs(W_ARR_RIP3[Wleft_bin] - Wgen) +
  ...
  for (Short_t i = 2; i < 6; i++) {
    ...
    sigma_final[i] = sigma_final[i] * (sigma_wright[i] * fabs(W_ARR_RIP3[Wleft_bin] - Wgen) +

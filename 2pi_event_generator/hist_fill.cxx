...
void hist_fill(Float_t E_beam, Float_t W, Float_t W_old, Float_t Q2, Float_t Q2_old, Float_t phi_e, Float_t z_EL,
               ...
               TLorentzVector P4_Eini_fermi, TLorentzVector P4_E_prime_new, TLorentzVector P4_E_prime_new2) {
  Float_t xsect_int_test_t, xsect_int_test_l;
  // if (W < 3.0125) interpol_int(Q2,W,xsect_int_test_t, xsect_int_test_l);

  TLorentzVector P4_0_miss, P4_0_miss_2, P4_pim_miss, P4_pim_miss_2, P4_0_miss_fermi, P4_0_miss_fermi_2,
      P4_pim_miss_fermi, P4_pim_miss_fermi_2;

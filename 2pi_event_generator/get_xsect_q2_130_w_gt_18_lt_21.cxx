...
//if ((isnan(sigma_wright[0]))||(isnan(sigma_wleft[0]))||(isnan(sigma_t_wleft_gol))||(isnan(sigma_t_wright_gol))||(isnan(W_ARR_RIP2[Wleft_bin])) || (isnan(W_ARR_RIP2[Wleft_bin]))) cout << sigma_wright[0]<< " "<<sigma_wleft[0]<<" "<<sigma_t_wleft_gol<<" "<<sigma_t_wright_gol<<" "<<W_ARR_RIP2[Wleft_bin]<<" "<<W_ARR_RIP2[Wleft_bin]<<" subr\n";
...
//if (isnan(sigma_t_rip2)) cout << sigma_wright[0]<<" "<< sigma_wleft[0]<<" "<<W_ARR_RIP2[Wleft_bin]<< " subr\n";
//if (isnan(sigma_t_final)) cout <<Wgen<<" "<<Q2gen<<" "<<sigma_t_final<< " "<<sigma_t_rip2<<" "<< sigma_t_gol<<"  subr\n";
};
